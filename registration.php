...
<html lang="es">
<head>
    <title>Bella Cosmetics |Registro</title>
    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Bella Cosmetics</small></h1>
            </div>
            <p class="lead text-center">
               Ingrese sus datos para poder registrarse como usuario en el sitio, una vez registrado tendra acceso a realizar compras.
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/labia.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
                    <div id="container-form">
                       ...
                       <form class="FormCatElec" action="process/regclien.php" role="form" method="POST" data-form="save">
                          ...
                          <p><button type="submit" class="btn btn-primary btn-block btn-raised" style="background-color:#EF0D5F">Registrarse</button></p>
                        </form> 
                    </div> 
                </div>
            </div>
