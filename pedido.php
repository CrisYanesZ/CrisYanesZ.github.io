...
<meta charset="UTF-8">
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=ARg7-XKJ-LZlW437q25HLeO1Uuhl2HcusFcvJl8xS3Awl5r2JHFEP6rWd0NiZ0I8BfMFN0NM7vjggH2X&currency=MXN"></script>
</head>
    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">Bella Cosmetics</small></h1>
            </div>
            <a href="factura.php" class="btn btn-default"><span class="glyphicon glyphicon-list-alt" 
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <p class="text-center">
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran" style="background-color:#EF0D5F">Transaccion Bancaria</button>
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                        <tr>
                                            ...
                                            <td>< <a href="factura.php?NumPedido=<?php echo $rw['NumPedido']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-list-alt" 
style="color:green;font-size:30px"></span></a></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
